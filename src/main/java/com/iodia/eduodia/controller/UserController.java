...
import com.iodia.eduodia.service.UserService;
...
public class UserController
{
    ...
    public ResponseEntity<?> getUser(@PathVariable("id") long id)
    {
        ...
        if (user == null) {
            ...
            return new ResponseEntity(new Exception("User with id " + id + " not found"), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> createUser(@RequestBody User user, UriComponentsBuilder ucBuilder)
    {
        ...
        if (userService.isUserExist(user)) {
            ...
            return new ResponseEntity(
                new Exception("Unable to create. A User with name " + user.getFirstName() + " already exist."),
                HttpStatus.CONFLICT);
        }
